...
function CalculatorInformation() {
  return (
    <div className="text-center py-8 px-4">
      <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-8">Idaho Wheat Calculator</h1>
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
          <h2 className="text-xl font-bold text-gray-800 mb-3">What is this page about?</h2>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
          <h2 className="text-xl font-bold text-gray-800 mb-3">How to use this page?</h2>
          <p className="text-gray-600 leading-relaxed">
